function y=Generate_input(SCALE, EdgesPerVertex, NumOfMachines)
%%%%%%%%%%%%%%%
%%% KronGraph500NoPerm:  scale: 2^scale is the number of nodes in the graph   
%%%                      EdgesPervertex: num of edges per vertice
%%%
%%%
%%%
%%%
...
disp(['Total number of nodes are ' num2str(Nmax) 'Total edges are ' num2str(M)]);              % Set algorithm inputs.


Nfile = NumOfMachines;                                       % Set the number of files to save to.
