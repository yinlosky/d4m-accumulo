...
tic;
%myV = 1:NumOfNodes;
myV = global_ind(zeros(NumOfNodes,1,map([Np 1],{},0:Np-1)));    % PARALLEL.
...
colStr;
valStr;
put(output,Assoc(colStr,rowStr,valStr)); %//A is symmetric, we switch the col and row to get the result
