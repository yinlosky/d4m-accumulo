function MainForLoop(NumOfMachines,  NumOfProcessors, NumOfNodes, max_iteration,eig_k,KeepB,Nostat,Store)
%%
...
fwrite(fstat,['**Bluewave Commands:  MainForLoop( ' num2str(NumOfMachines) ',' num2str(NumOfProcessors) ',' num2str(NumOfNodes) ','  num2str(max_iteration) ',' num2str(eig_k) ',' num2str(KeepB) ',' num2str(Nostat) ',' num2str(Store) ')' 'sparseness: ' num2str(EdgesPerVertex) ]);
...
%%%%%%%%%%%%%%%%%
	switch NumOfMachines
		  ...
		  %machines={'n124' 'n125' 'n126' 'n127' 'n128' 'n129' 'n130' 'n131' 'n132'};
           case 10
          ...
          case 15
                  machines={'n118' 'n119' 'n120' 'n121' 'n122' 'n123' 'n124' 'n125' 'n126' 'n127' 'n128' 'n129' 'n130' 'n131' 'n132'};
          case 16
...
disp([sprintf('\tRunning ForLoop with the following configuration:\n')]);
