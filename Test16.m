function Test16(NumOfMachines, NumOfNodes, max_iteration, NumOfProcessors,eig_k)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
diary TOCOMPAREWITHlogsfortesting16with4Nodes.txt;
...
%machines={'hec-51' 'hec-50'}; %To run in two nodes
