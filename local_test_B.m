function test_parallel_eigen_B(NumOfMachines, NumOfNodes, max_iteration, NumOfProcessors,eig_k)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
machines={}; %To run in two nodes
%machines={};% To run locally
...
for it = 1:max_iteration
	...
	num_ortho = local_selective_orthogonalize(it, bet(it), v_path, Q,D, NumOfNodes, NumOfMachines,NumOfProcessors);
